...
{
    public static class PayMeCert
    {
        public static string PayMePubKey(string env)
        {
        ...
        public static string PayMePriKey(string env)
        {
            ...
            return pripem;
        }public static string PayMeSDKPubKey(string env)
        {
            string key = "-----BEGIN PUBLIC KEY-----\n"
        ...
        public static string PayMeSDKPriKey(string env)
        {
            var pripem = "-----BEGIN RSA PRIVATE KEY-----\n"
