...
{
    public class ExportOverDueDateDebt
    {
        ...
        [Export(ExportName = "first_referee")]
        public string FirstReferee { get; set; }

        [Export(ExportName = "second_referee")]
        ...
        [Export(ExportName = "over_due_date")]
        public DateTime? OverDueDate { get; set; }

        [Export(ExportName = "numberOverDueDate")]
